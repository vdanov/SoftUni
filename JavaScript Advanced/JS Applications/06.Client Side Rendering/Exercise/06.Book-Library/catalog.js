import { html, until, getBooks, deleteBook } from './util.js';
// list module:
...
async function loadBooks(ctx) {
    ...
    return Object.values(books).map(book => bookRow(book, onEdit.bind(null, book, ctx), onDelete.bind(null, book, ctx)));    
}
